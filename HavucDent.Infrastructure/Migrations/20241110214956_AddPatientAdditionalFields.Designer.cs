...
namespace HavucDent.Infrastructure.Migrations
{
    ...
    [Migration("20241110214956_AddPatientAdditionalFields")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HavucDent.Domain.Entities.AppointmentLaboratory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppointmentLaboratories");
                });

            modelBuilder.Entity("HavucDent.Domain.Entities.Laboratory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("UpdatedByUserMail")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HavucDent.Domain.Entities.Doctor", b =>
                {
                    ...
                    b.Property<decimal>("LaboratoryCommissionRate")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("HavucDent.Domain.Entities.AppointmentLaboratory", b =>
                {
                    b.HasOne("HavucDent.Domain.Entities.Appointment", "Appointment")
                        .WithMany("AppointmentLaboratories")
                        .HasForeignKey("AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HavucDent.Domain.Entities.Laboratory", "Laboratory")
                        .WithMany("AppointmentLaboratories")
            ...
            modelBuilder.Entity("HavucDent.Domain.Entities.Patient", b =>
                {
                    b.HasOne("HavucDent.Domain.Entities.User", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("HavucDent.Domain.Entities.Appointment", b =>
                {
                    b.Navigation("AppointmentLaboratories");
                });
